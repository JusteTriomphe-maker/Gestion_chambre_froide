...
namespace App\Models {
     ...
     * @property int $id
     * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\StockExit> $stockExits
     * @property-read int|null $stock_exits_count
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Client>|Client whereContactInfo($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Client>|Client whereTotalDebt($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Debt>|Debt whereClientId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Debt>|Debt whereSupplierId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Debt>|Debt whereAmount($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Debt>|Debt whereType($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Debt>|Debt whereDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Debt>|Debt whereNotes($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Debt>|Debt whereReference($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Debt>|Debt wherePaidAmount($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Debt>|Debt whereStatus($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Debt>|Debt forClient(mixed $clientId) {@see App\Models\Debt::scopeForClient()}
     * @method static \Illuminate\Database\Eloquent\Builder<Debt>|Debt forSupplier(mixed $supplierId) {@see App\Models\Debt::scopeForSupplier()}
     * @method static \Illuminate\Database\Eloquent\Builder<Debt>|Debt credits() {@see App\Models\Debt::scopeCredits()}
     * @method static \Illuminate\Database\Eloquent\Builder<Debt>|Debt debits() {@see App\Models\Debt::scopeDebits()}
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * App\Models\Product
     *
     * @property float|null $price_per_carton
     * @property float|null $kg_per_carton
     * @property string $stock_mode
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product wherePriceBuying($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product wherePriceSelling($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product whereUnit($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product whereMinThreshold($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product whereStockMode($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product whereKgPerCarton($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Product>|Product wherePricePerCarton($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Sale>|Sale whereReceiptNumber($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Sale>|Sale whereIsPaid($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Sale>|Sale wherePaidAt($value)
     ...
     * @property float|null $input_quantity
     * @property string $input_unit
     * @property \Illuminate\Support\Carbon|null $updated_at
     * @property \Illuminate\Support\Carbon|null $created_at
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<SaleItem>|SaleItem whereInputUnit($value)
     * @method static \Illuminate\Database\Eloquent\Builder<SaleItem>|SaleItem whereInputQuantity($value)
     * @method static \Illuminate\Database\Eloquent\Builder<SaleItem>|SaleItem whereConversionRate($value)
     ...
     * @property-read \App\Models\Product $product
     * @property-read \App\Models\Supplier $supplier
     * @method static \Illuminate\Database\Eloquent\Builder<StockEntry>|StockEntry whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockEntry>|StockEntry whereProductId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockEntry>|StockEntry whereSupplierId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockEntry>|StockEntry whereQuantity($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockEntry>|StockEntry whereExpirationDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockEntry>|StockEntry whereEntryDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockEntry>|StockEntry whereBatchNumber($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockEntry>|StockEntry whereUnitPrice($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockEntry>|StockEntry whereIsPaid($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockEntry>|StockEntry whereNotes($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockEntry>|StockEntry whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockEntry>|StockEntry whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockEntry>|StockEntry whereInputUnit($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockEntry>|StockEntry whereInputQuantity($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockEntry>|StockEntry whereConversionRate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockEntry>|StockEntry newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<StockEntry>|StockEntry newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<StockEntry>|StockEntry query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class StockEntry extends \Illuminate\Database\Eloquent\Model
    {
        //
    }

    /**
     * App\Models\StockExit
     *
     * @property float|null $conversion_rate
     * @property float|null $input_quantity
     * @property string $input_unit
     ...
     * @property \Illuminate\Support\Carbon $exit_date
     * @property float $quantity
     * @property int|null $client_id
     * @property int $product_id
     * @property int $id
     ...
     * @property-read \App\Models\Client $client
     * @property-read \App\Models\User $user
     * @method static \Illuminate\Database\Eloquent\Builder<StockExit>|StockExit whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockExit>|StockExit whereProductId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockExit>|StockExit whereClientId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockExit>|StockExit whereQuantity($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockExit>|StockExit whereExitDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockExit>|StockExit whereReason($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockExit>|StockExit whereUnitPrice($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockExit>|StockExit whereIsPaid($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockExit>|StockExit whereNotes($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockExit>|StockExit whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockExit>|StockExit whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockExit>|StockExit whereUserId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockExit>|StockExit whereInputUnit($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockExit>|StockExit whereInputQuantity($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockExit>|StockExit whereConversionRate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<StockExit>|StockExit newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<StockExit>|StockExit newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<StockExit>|StockExit query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @mixin \Illuminate\Database\Query\Builder
     */
    class StockExit extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Supplier>|Supplier whereTotalDebt($value)
