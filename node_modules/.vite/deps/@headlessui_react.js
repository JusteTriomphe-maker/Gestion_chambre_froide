...
function _render(props, slot, tag, name) {
  ...
  if (Component === import_react.Fragment) {
    if (Object.keys(passThroughProps).length > 0) {
      ...
      return (0, import_react.cloneElement)(resolvedChildren, Object.assign(
        {},
        // Filter out undefined values so that they don't override the existing values
        mergeEventFunctions(compact(omit(passThroughProps, ["ref"])), resolvedChildren.props, ["onClick"]),
        refRelatedProps
      ));
    }
  }
...
var focusableSelector = ["[contentEditable=true]", "[tabindex]", "a[href]", "area[href]", "button:not([disabled])", "iframe", "input:not([disabled])", "select:not([disabled])", "textarea:not([disabled])"].map(false ? (
...
var ForcePortalRootContext = (0, import_react.createContext)(false);
function usePortalRoot() {
  return (0, import_react.useContext)(ForcePortalRootContext);
}
function ForcePortalRoot(props) {
  return import_react.default.createElement(ForcePortalRootContext.Provider, {
    value: props.force
  }, props.children);
}
function usePortalTarget() {
  var forceInRoot = usePortalRoot();
  var groupTarget = (0, import_react.useContext)(PortalGroupContext);
...
function Portal(props) {
  ...
  return import_react.default.createElement(StackProvider, null, !target || !element ? null : (0, import_react_dom.createPortal)(render({
    props: passthroughProps,
    defaultTag: DEFAULT_PORTAL_TAG,
    name: "Portal"
  }), element));
}
var DEFAULT_GROUP_TAG = import_react.Fragment;
var PortalGroupContext = (0, import_react.createContext)(null);
function Group(props) {
  var target = props.target, passthroughProps = _objectWithoutPropertiesLoose(props, ["target"]);
  return import_react.default.createElement(PortalGroupContext.Provider, {
    value: target
  }, render({
    props: passthroughProps,
...
Portal.Group = Group;
var DescriptionContext = (0, import_react.createContext)(null);
function useDescriptionContext() {
  var context = (0, import_react.useContext)(DescriptionContext);
  if (context === null) {
...
function useDescriptions() {
  var _useState = (0, import_react.useState)([]), descriptionIds = _useState[0], setDescriptionIds = _useState[1];
  return [
    ...
    (0, import_react.useMemo)(function() {
      return function DescriptionProvider(props) {
        var register = (0, import_react.useCallback)(function(value) {
        ...
        return import_react.default.createElement(DescriptionContext.Provider, {
          value: contextBag
        }, props.children);
      };
    }, [setDescriptionIds])
...
var reducers = (_reducers = {}, _reducers[ActionTypes.SetTitleId] = function(state2, action) {
  if (state2.titleId === action.id) return state2;
...
var DialogRoot = forwardRefWithAs(function Dialog(props, ref) {
  ...
  var containers = (0, import_react.useRef)(/* @__PURE__ */ new Set());
  ...
  var slot = (0, import_react.useMemo)(function() {
    return {
  ...
  }, import_react.default.createElement(ForcePortalRoot, {
    force: true
  }, import_react.default.createElement(Portal, null, import_react.default.createElement(DialogContext.Provider, {
    value: contextBag
  }, import_react.default.createElement(Portal.Group, {
    target: internalDialogRef
  }, import_react.default.createElement(ForcePortalRoot, {
    force: false
  }, import_react.default.createElement(DescriptionProvider, {
    slot,
...
var reducers$1 = (_reducers$1 = {}, _reducers$1[ActionTypes$1.ToggleDisclosure] = function(state2) {
  ...
  if (state2.linkedPanel === true) return state2;
  return _extends({}, state2, {
    linkedPanel: true
  });
}, _reducers$1[ActionTypes$1.UnlinkPanel] = function(state2) {
  if (state2.linkedPanel === false) return state2;
  return _extends({}, state2, {
    linkedPanel: false
  });
...
var reducers$2 = (_reducers$2 = {}, _reducers$2[ActionTypes$2.CloseListbox] = function(state2) {
  if (state2.disabled) return state2;
  if (state2.listboxState === ListboxStates.Closed) return state2;
  return _extends({}, state2, {
  ...
  if (state2.disabled) return state2;
  if (state2.listboxState === ListboxStates.Open) return state2;
  return _extends({}, state2, {
    listboxState: ListboxStates.Open
  });
}, _reducers$2[ActionTypes$2.SetDisabled] = function(state2, action) {
  if (state2.disabled === action.disabled) return state2;
  return _extends({}, state2, {
  ...
  if (state2.searchQuery === "" && state2.activeOptionIndex === activeOptionIndex) return state2;
  return _extends({}, state2, {
    searchQuery: "",
    activeOptionIndex
  });
  ...
  if (match2 === -1 || match2 === state2.activeOptionIndex) return _extends({}, state2, {
    searchQuery
  });
  return _extends({}, state2, {
    searchQuery,
  ...
  if (state2.disabled) return state2;
  if (state2.listboxState === ListboxStates.Closed) return state2;
  if (state2.searchQuery === "") return state2;
  return _extends({}, state2, {
    searchQuery: ""
  });
  ...
  return _extends({}, state2, {
    ...
    activeOptionIndex: function() {
      if (idx === state2.activeOptionIndex) return null;
...
var Button$1 = forwardRefWithAs(function Button3(props, ref) {
    ...
    switch (event.key) {
      ...
      case Keys.ArrowDown:
        ...
        d.nextFrame(function() {
          if (!state2.propsRef.current.value) dispatch({
  ...
  var labelledby = useComputed(function() {
    if (!state2.labelRef.current) return void 0;
...
var Options = forwardRefWithAs(function Options2(props, ref) {
  ...
  useIsoMorphicEffect(function() {
    ...
    if (!container) return;
    if (state2.listboxState !== ListboxStates.Open) return;
  ...
  return render({
    ...
    visible: state2.listboxState === ListboxStates.Open,
...
function useTreeWalker(_ref) {
  ...
  var acceptRef = (0, import_react.useRef)(accept);
  var walkRef = (0, import_react.useRef)(walk);
  (0, import_react.useEffect)(function() {
...
var reducers$3 = (_reducers$3 = {}, _reducers$3[ActionTypes$3.CloseMenu] = function(state2) {
  if (state2.menuState === MenuStates.Closed) return state2;
  return _extends({}, state2, {
    activeItemIndex: null,
    menuState: MenuStates.Closed
  });
}, _reducers$3[ActionTypes$3.OpenMenu] = function(state2) {
  if (state2.menuState === MenuStates.Open) return state2;
  return _extends({}, state2, {
  ...
  if (state2.searchQuery === "" && state2.activeItemIndex === activeItemIndex) return state2;
  return _extends({}, state2, {
    searchQuery: "",
    activeItemIndex
  });
  ...
  if (match2 === -1 || match2 === state2.activeItemIndex) return _extends({}, state2, {
    searchQuery
  });
  return _extends({}, state2, {
    searchQuery,
  ...
  return _extends({}, state2, {
    ...
    activeItemIndex: function() {
      if (idx === state2.activeItemIndex) return null;
...
var Button$2 = forwardRefWithAs(function Button4(props, ref) {
...
var Items = forwardRefWithAs(function Items2(props, ref) {
  ...
  (0, import_react.useEffect)(function() {
    ...
    if (!container) return;
    if (state2.menuState !== MenuStates.Open) return;
    if (container === document.activeElement) return;
    container.focus({
      preventScroll: true
    });
  ...
  return render({
    ...
    visible: state2.menuState === MenuStates.Open,
    name: "Menu.Items"
  });
});
...
var Button$3 = forwardRefWithAs(function Button5(props, ref) {
    ...
    if (isWithinPanel) {
      ...
      switch (event.key) {
        ...
        case Keys.Enter:
          event.preventDefault();
          event.stopPropagation();
          if (state2.popoverState === PopoverStates.Closed) closeOthers == null ? void 0 : closeOthers(state2.buttonId);
          dispatch({
            type: ActionTypes$4.TogglePopover
          });
          break;
        case Keys.Escape:
          if (state2.popoverState !== PopoverStates.Open) return closeOthers == null ? void 0 : closeOthers(state2.buttonId);
        ...
        case Keys.Tab:
          ...
          if (event.shiftKey) {
            ...
            if ((_state$button2 = state2.button) == null ? void 0 : _state$button2.contains(previousActiveElementRef.current)) return;
            if (state2.panel.contains(previousActiveElementRef.current)) return;
  ...
  var handleKeyUp = (0, import_react.useCallback)(function(event) {
    ...
    switch (event.key) {
      case Keys.Tab:
        if (!previousActiveElementRef.current) return;
        if ((_state$button3 = state2.button) == null ? void 0 : _state$button3.contains(previousActiveElementRef.current)) return;
        if (state2.panel.contains(previousActiveElementRef.current)) return;
        var focusableElements = getFocusableElements();
        var previousIdx = focusableElements.indexOf(previousActiveElementRef.current);
        var buttonIdx = focusableElements.indexOf(state2.button);
...
var Overlay$1 = forwardRefWithAs(function Overlay3(props, ref) {
...
var Panel$1 = forwardRefWithAs(function Panel3(props, ref) {
  ...
  return import_react.default.createElement(PopoverPanelContext.Provider, {
    ...
    visible: state2.popoverState === PopoverStates.Open,
    name: "Popover.Panel"
  }));
});
...
function Group$1(props) {
  ...
  var isFocusWithinPopoverGroup = (0, import_react.useCallback)(function() {
    ...
    if ((_groupRef$current = groupRef.current) == null ? void 0 : _groupRef$current.contains(element)) return true;
...
function useFlags(initialFlags) {
  ...
  var _useState = (0, import_react.useState)(initialFlags), flags = _useState[0], setFlags = _useState[1];
  var addFlag = (0, import_react.useCallback)(function(flag) {
    return setFlags(function(flags2) {
      return flags2 | flag;
    });
  }, [setFlags]);
  var hasFlag = (0, import_react.useCallback)(function(flag) {
    return Boolean(flags & flag);
  }, [flags]);
  var removeFlag = (0, import_react.useCallback)(function(flag) {
    return setFlags(function(flags2) {
      return flags2 & ~flag;
    });
  }, [setFlags]);
  var toggleFlag = (0, import_react.useCallback)(function(flag) {
    return setFlags(function(flags2) {
      return flags2 ^ flag;
    });
  }, [setFlags]);
...
var LabelContext = (0, import_react.createContext)(null);
function useLabelContext() {
  var context = (0, import_react.useContext)(LabelContext);
  if (context === null) {
...
function useLabels() {
  var _useState = (0, import_react.useState)([]), labelIds = _useState[0], setLabelIds = _useState[1];
  return [
    // The actual id's as string or undefined.
    ...
    (0, import_react.useMemo)(function() {
      return function LabelProvider(props) {
        ...
        return import_react.default.createElement(LabelContext.Provider, {
          value: contextBag
        }, props.children);
      };
    }, [setLabelIds])
...
function useRadioGroupContext(component) {
  var context = (0, import_react.useContext)(RadioGroupContext);
  if (context === null) {
...
function RadioGroup(props) {
  var value = props.value, onChange = props.onChange, passThroughProps = _objectWithoutPropertiesLoose(props, ["value", "onChange"]);
  var reducerBag = (0, import_react.useReducer)(stateReducer$5, {
    propsRef: {
      current: {
        value,
        onChange
  ...
  var _reducerBag$ = reducerBag[0], propsRef = _reducerBag$.propsRef, options = _reducerBag$.options;
  var _useLabels = useLabels(), labelledby = _useLabels[0], LabelProvider = _useLabels[1];
  var _useDescriptions = useDescriptions(), describedby = _useDescriptions[0], DescriptionProvider = _useDescriptions[1];
  var id2 = "headlessui-radiogroup-" + useId();
  var radioGroupRef = (0, import_react.useRef)(null);
  useIsoMorphicEffect(function() {
    propsRef.current.value = value;
  }, [value, propsRef]);
  useIsoMorphicEffect(function() {
  ...
  var triggerChange = (0, import_react.useCallback)(function(nextValue) {
  ...
  return import_react.default.createElement(DescriptionProvider, {
    name: "RadioGroup.Description"
  }, import_react.default.createElement(LabelProvider, {
    name: "RadioGroup.Label"
  }, import_react.default.createElement(RadioGroupContext.Provider, {
    value: reducerBag
  }, render({
    props: _extends({}, passThroughProps, propsWeControl),
...
function Option$1(props) {
  var _options$;
  var optionRef = (0, import_react.useRef)(null);
  ...
  var value = props.value, passThroughProps = _objectWithoutPropertiesLoose(props, ["value"]);
  var propsRef = (0, import_react.useRef)({
    value
  });
  useIsoMorphicEffect(function() {
    propsRef.current.value = value;
  }, [value, propsRef]);
  var _useRadioGroupContext = useRadioGroupContext([RadioGroup.name, Option$1.name].join(".")), _useRadioGroupContext2 = _useRadioGroupContext[0], radioGroupPropsRef = _useRadioGroupContext2.propsRef, options = _useRadioGroupContext2.options, dispatch = _useRadioGroupContext[1];
  useIsoMorphicEffect(function() {
    dispatch({
  ...
  var handleBlur = (0, import_react.useCallback)(function() {
    return removeFlag(OptionState.Active);
  }, [removeFlag]);
  var firstRadio = (options == null ? void 0 : (_options$ = options[0]) == null ? void 0 : _options$.id) === id2;
  ...
  var propsWeControl = {
    ...
    "aria-labelledby": labelledby,
    "aria-describedby": describedby,
    tabIndex: checked ? 0 : radioGroupPropsRef.current.value === void 0 && firstRadio ? 0 : -1,
    onClick: handleClick,
    onFocus: handleFocus,
    onBlur: handleBlur
  };
...
var DEFAULT_GROUP_TAG$2 = import_react.Fragment;
function Group$2(props) {
  ...
  }, import_react.default.createElement(GroupContext.Provider, {
    value: context
  }, render({
    props,
